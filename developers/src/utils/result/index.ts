...
export type ResultOkType<T extends Either<any, any>> = T extends Either<infer U, any> ? U : never
export type ResultFailType<T extends Either<any, any>> = T extends Either<any, infer U> ? U : never
